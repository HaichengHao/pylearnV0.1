...
# https://zz.fang.lianjia.com/loupan/jinshuiqu1/nhs1pg1/
# https://zz.fang.lianjia.com/loupan/jinshuiqu1/nhs1pg2/
# https://zz.fang.lianjia.com/loupan/jinshuiqu1/nhs1pg3/


# //div[@class="resblock-name"] <--楼盘名字和标签分类
# //div[@class="resblock-name"]/a/@title <--楼盘名字
# //div[@class="resblock-location"]/span/text() <--所在区域
# //div[@class="main-price"]/span/text() <--楼盘均价
